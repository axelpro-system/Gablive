...
-- NOTA: o aperto das políticas (DROP das policies USING(true)) NÃO está aqui.
-- Ele fica na migration 009, aplicada SÓ depois do frontend com RPC estar no
-- ar — senão o frontend antigo (que lê as tabelas direto) quebraria. Esta
-- migration é puramente aditiva: cria as funções, não muda comportamento.
